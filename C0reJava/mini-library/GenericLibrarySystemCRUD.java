        ...
        do {
            ...
            switch (choice) {
                ...
                case 7:
                    ...
                    int bookIndex = bookLibrary.searchItem(new Book(sbTitle, sbAuthor));
                    System.out.println(bookIndex >= 0 ? "Book Found at index " + bookIndex : "Book Not Found!");
                    break;
                ...
                case 8:
                    ...
                    sc.nextLine();
                    int magIndex = magazineLibrary.searchItem(new Magazine(smName, smIssue));
                    System.out.println(magIndex >= 0 ? "Magazine Found at index " + magIndex : "Magazine Not Found!");
                    break;
                ...
                case 9:
                    ...
                    int dvdIndex = dvdLibrary.searchItem(new DVD(sdTitle, sdGenre));
                    System.out.println(dvdIndex >= 0 ? "DVD Found at index " + dvdIndex : "DVD Not Found!");
                    break;
                ...
                case 10:
                    ...
                    bookLibrary.updateItem(bIndex, new Book(nbTitle, nbAuthor));
                    break;
                ...
                case 11:
                    ...
                    int ni = sc.nextInt();
                    sc.nextLine();
                    magazineLibrary.updateItem(mIndex, new Magazine(nmName, ni));
                    break;
                ...
                case 12:
                    ...
                    dvdLibrary.updateItem(dIndex, new DVD(ndTitle, ndGenre));
                    break;
